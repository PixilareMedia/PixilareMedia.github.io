...
let downloadsBetaServerPanel: HTMLDivElement;
let downloadsAlphaPanel: HTMLDivElement;
let modsListPanel: HTMLDivElement;
//Button elements.
let downloadsButton: HTMLButtonElement;
let downloadsBetaButton: HTMLButtonElement;
let downloadsBetaServerButton: HTMLButtonElement;
let downloadsAlphaButton: HTMLButtonElement;
...
function categoryButtonSetup() {
  ...
  //Register the Beta Server Downloads Panel button.
  downloadsBetaServerPanel = document.getElementById("downloads-beta-server") as HTMLDivElement;
  downloadsBetaServerButton = document.getElementById("downloads-beta-server-button") as HTMLButtonElement;
  downloadsBetaServerButton.onclick = () => {
    openCloseDownloads(downloadsBetaServerPanel);
  }
  //Register the Alpha Downloads Panel button.
  downloadsAlphaPanel = document.getElementById("downloads-alpha") as HTMLDivElement;
  downloadsAlphaButton = document.getElementById("downloads-alpha-button") as HTMLButtonElement;
  downloadsAlphaButton.onclick = () => {
    openCloseDownloads(downloadsAlphaPanel);
  }
}
...
function hideCatagoryDivs() {
  ...
  downloadsBetaServerPanel.style.display = "none";
  downloadsAlphaPanel.style.display = "none";
